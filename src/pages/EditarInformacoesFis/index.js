...
import { getAuth, updateEmail, updatePassword, EmailAuthCredential, EmailAuthProvider, reauthenticateWithCredential } from "firebase/auth";
        ...
        if (datanascimento === "" || email === "" || telefone === "" || senhaAtual === "") {
            ...
            reauthenticate(senhaAtual)
                .then(response => {
                    ...
                    setDoc(userRef, { datanascimento: datanascimento, email: email, telefone: telefone }, { merge: true })
                        .then(refs => {
