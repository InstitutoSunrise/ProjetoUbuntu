...
export default function finalCarregamento({onClick}) {
    return (
        <View style={[StyleSheet.absoluteFillObject, styles.container]}>
            ...
            <View style={styles.viewIndicator}>
                ...
                <Text style={styles.text}>Publicado com sucesso</Text>
                <TouchableOpacity onPress={onClick}><Text style={styles.btnText}>OK</Text></TouchableOpacity>
            </View>
        </View>
    );
}
